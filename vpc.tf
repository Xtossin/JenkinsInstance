...
resource "aws_subnet" "xtos-main-public-1" {
    ...
    tags {
        Name = "xtos-main-public-1"
    }
}
resource "aws_subnet" "xtos-main-public-2" {
    vpc_id = "${aws_vpc.xtos-main.id}"
    ...
    tags {
        Name = "xtos-main-public-2"
    }
}
resource "aws_subnet" "xtos-main-public-3" {
    vpc_id = "${aws_vpc.xtos-main.id}"
...
resource "aws_route_table_association" "main-public-2-a" {
    subnet_id = "${aws_subnet.xtos-main-public-2.id}"
    route_table_id = "${aws_route_table.main-public.id}"
}
resource "aws_route_table_association" "main-public-3-a" {
    subnet_id = "${aws_subnet.xtos-main-public-3.id}"
    route_table_id = "${aws_route_table.main-public.id}"
}
